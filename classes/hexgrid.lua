local c = class("hexgrid",classes.grid)
...
c.initialize = function (self, width, height, tilesize)
	self:InitGrid(3)
	
	self:GetGrid():initHexGrid(width, height, tilesize)
	self:SetConversion("oddr")
end
